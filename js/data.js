...
OMT.chapters = [
  ...
  { id: "openness", num: "1", part: "Primer",     file: "chapters/01-what-open-means.html", title: "What 'Open' Means", minutes: 20,
    blurb: "Open source vs open weights vs fully open. The release gradient, licenses, the artifacts that make a model reproducible, and why the words are contested.",
...
OMT.glossary = {
  ...
  "open-weights": ["Open weights", "A release where the trained parameters can be downloaded and run locally, but training data, code and full recipe may be withheld. Llama, Qwen, DeepSeek, Kimi and GLM are open-weights."],
  "fully-open": ["Fully open", "A release that includes weights plus training data, training code, evaluation code and intermediate checkpoints, enough to reproduce or scientifically study the model. Pythia, OLMo and Olmo 3 are the reference examples."],
